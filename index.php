...
<div class="body container mt-5">
    <div class="body-header">
            ...
            <?php else: ?>
                <?php echo '<h1 style="text-transform: capitalize;">Hello '.$active_user['username'].'</h1>'?>
            <?php endif ?>
    </div>
    <hr/>
    <?php if($active_user !== ''): ?>
                ...
                <div class="card blog-card ms-0 m-3 border-1" style="width: 360px; height: auto;">
                    ...
                    <div class="card-footer mt-3 ms-3 d-flex justify-content-between">
                        <div class="card-footer-left">
                            <p class="lead" style="text-transform: capitalize;">By <?php echo get_user($blog['user_id'])?></p>
                        ...
                        <div class="card-footer-right d-flex">
                            <?php if(isset($_SESSION['active_user'])): ?>
                                <div class="like">
                                    ...
                                    <?php endif ?>
                                    <p class="fw-light ps-3"><?php echo count(array_filter($bloglikes, function($bloglike) use($blog){
                                        return $bloglike['blog_id'] == $blog['id'];
                                    })) ?></p>
                                </div>
